...
class Saliency_feat_decoder(nn.Module):
    ...
    def __init__(self, channel):
        ...
        self.conv_rf = BasicConv2d(in_planes=channel, out_planes=1, kernel_size=1)
...
# class Saliency_interaction(nn.Module):
#     def __init__(self, channel):
#         super(Saliency_interaction, self).__init__()
#         self.relu = nn.ReLU(inplace=True)
#         # self.dropout = nn.Dropout(0.3)
#         # self.clc_layer = self._make_pred_layer(Classifier_Module, [6, 12, 18, 24], [6, 12, 18, 24], 1, channel*2)

#         # self.racb12 = RCAB_for_pred(channel*2)
#         self.conv_b1_x1 = BasicConv2d(in_planes=channel*2, out_planes=channel, kernel_size=3, padding=1)
#         self.conv_b1_x2 = BasicConv2d(in_planes=channel, out_planes=channel, kernel_size=3, padding=1)
#         self.conv_b1_x3 = BasicConv2d(in_planes=channel, out_planes=channel, kernel_size=3, padding=1)
#         self.conv_b1_x4 = BasicConv2d(in_planes=channel, out_planes=channel, kernel_size=3, padding=1)
#         self.conv_b1_x5 = BasicConv2d(in_planes=channel, out_planes=channel, kernel_size=3, padding=1)
        
#         self.conv_b2_x1 = BasicConv2d(in_planes=channel*2, out_planes=channel, kernel_size=3, padding=1)
#         self.conv_b2_x2 = BasicConv2d(in_planes=channel, out_planes=channel, kernel_size=3, padding=1)
#         self.conv_b2_x3 = BasicConv2d(in_planes=channel, out_planes=channel, kernel_size=3, padding=1)
#         self.conv_b2_x4 = BasicConv2d(in_planes=channel, out_planes=channel, kernel_size=3, padding=1)
#         self.conv_b2_x5 = BasicConv2d(in_planes=channel, out_planes=channel, kernel_size=3, padding=1)
...
#     def forward(self, x): 
#         init_x1 = self.relu(self.conv_b1_x1(x))
        
#         init_x2 = F.max_pool2d(init_x1, kernel_size = 2, stride = 2)
#         init_x2 = self.relu(self.conv_b1_x2(init_x2))
        
#         init_x3 = F.max_pool2d(init_x2, kernel_size = 2, stride = 2)
#         init_x3 = self.relu(self.conv_b1_x3(init_x3))
        
#         init_x4 = F.max_pool2d(init_x3, kernel_size = 2, stride = 2)
#         init_x4 = self.relu(self.conv_b1_x4(init_x4))

#         # init_x5 = F.max_pool2d(init_x4, kernel_size = 2, stride = 2)
#         init_x5 = self.relu(self.conv_b1_x5(init_x4))


        
#         contour_x1 = self.relu(self.conv_b2_x1(x))
        
#         contour_x2 = F.max_pool2d(contour_x1, kernel_size = 2, stride = 2)
#         contour_x2 = self.relu(self.conv_b2_x2(contour_x2))
        
#         contour_x3 = F.max_pool2d(contour_x2, kernel_size = 2, stride = 2)
#         contour_x3 = self.relu(self.conv_b2_x3(contour_x3))
        
#         contour_x4 = F.max_pool2d(contour_x3, kernel_size = 2, stride = 2)
#         contour_x4 = self.relu(self.conv_b2_x4(contour_x4))
        
#         # contour_x5 = F.max_pool2d(contour_x4, kernel_size = 2, stride = 2)
#         contour_x5 = self.relu(self.conv_b2_x5(contour_x4))
        
        
#         return init_x1, init_x2, init_x3, init_x4, init_x5, contour_x1, contour_x2, contour_x3, contour_x4, contour_x5


class Saliency_prediction(nn.Module):
    def __init__(self, channel):
        super(Saliency_prediction, self).__init__()
        self.relu = nn.ReLU(inplace=True)
        # self.dropout = nn.Dropout(0.3)
        # self.clc_layer = self._make_pred_layer(Classifier_Module, [6, 12, 18, 24], [6, 12, 18, 24], 1, channel*2)

        # self.racb12 = RCAB_for_pred(channel*2)
        self.conv = BasicConv2d(in_planes=channel*5*2, out_planes=channel*5, kernel_size=3, padding=1)
    ...
    def forward(self, x1, x2): 
        ...
        # x12 = self.racb12(x12)
        # x12 = self.relu((x12))
        sal_pred = self.conv(x12)
        sal_pred = self.relu(sal_pred)
...
class SwinDecoder(nn.Module):
    def __init__(self, img_size):
        ...
        # self.sal_in = Saliency_interaction(channel)
    ...
    def forward(self, x, tag):
        x1_b1, x2_b1, x3_b1, x4_b1, x5_b1, x1_b2, x2_b2, x3_b2, x4_b2, x5_b2 = self.res(x)
