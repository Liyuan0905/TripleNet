...
for dataset in test_datasets:
    ...
    save_path_mean_swin_body = './spv_results_mean_swin_body/' + dataset + '/'
    if not os.path.exists(save_path_mean_swin_body):
        os.makedirs(save_path_mean_swin_body)
    
    save_path_mean_swin_contour = './spv_results_mean_swin_contour/' + dataset + '/'
    if not os.path.exists(save_path_mean_swin_contour):
        os.makedirs(save_path_mean_swin_contour)
    
    save_path_mean_swin = './spv_results_mean_swin/' + dataset + '/'
